! intrinsic specific Lya luminosity [erg/s/Hz]
function intrinsic_profile(v_e)
  use param
  implicit none
  real*8 :: intrinsic_profile,v_e
  intrinsic_profile=L_lya * 1.d0/dsqrt(2.d0*pi*sigma_v**2)*dexp(-v_e**2/(2.d0*sigma_v**2))
  return
end function intrinsic_profile
