...
plot(s,xi_0,'r-', linewidth=2,label='REF model')
...
plot(s[1:],xi_2[1:]/xi_0[1:],'b-', linewidth=2,label='REF model')
#plot(s[1:],xi_4[1:],'m-', linewidth=2,label='$\\xi_4$')
#plot(s[1:],-xi_2[1:]/(F.max()-xi_0[1:]),'g-', linewidth=2,label='$-\\xi_2/(1-\\xi_0)$')
