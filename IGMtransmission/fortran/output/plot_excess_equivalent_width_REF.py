...
semilogx(1000*r,2.*dEW,'r-',label='REF model')
errorbar(impact_parameter,EW_steidel,yerr=err,xerr=[xerr1,xerr2],fmt='o',label='Galaxy-galaxy pairs, Steidel+2010')
errorbar(b_Rakic,EW_Rakic,yerr=err_Rakic,fmt='s',xerr=[xerr1_Rakic,xerr1_Rakic],label='QSO-galaxy pairs, Rakic+2012')
#ylim(0.1,10.0)
ylim(0,3.8)
xlim(10,4000)
